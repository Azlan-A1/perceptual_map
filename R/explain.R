...
explain_ui <- function(cars, attrs) {
  ...
  tags$div(class = "xp",
    ...
    xp_sec(6, "How the picture gets drawn",
    ...
    xp_sec(7, "What this map cannot tell you",
      tags$ul(class = "mb-0",
    ...
    xp_sec(8, "Where the code lives",
      tags$div(class = "table-responsive",
        tags$table(class = "table table-sm mb-0",
          tags$tbody(
            tags$tr(tags$td(tags$code("R/pca.R")),
                    tags$td(class = "text-body-secondary", "Transforms, scaling, sign pinning, correlation loadings, axis naming")),
            ...
            tags$tr(tags$td(tags$code("R/layout.R")),
                    tags$td(class = "text-body-secondary", "Axis limits, aspect fitting, force-directed label repel, inset placement")),
